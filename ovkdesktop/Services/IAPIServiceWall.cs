...
namespace ovkdesktop.Services
{
    public interface IAPIServiceWall
    {
        ...
        Task<List<UserWallPost>> GetHydratedWallAsync(string token, long ownerId, UserProfile userOwner, GroupProfile groupOwner, int offset = 0, int count = 20, CancellationToken cancellationToken = default);
